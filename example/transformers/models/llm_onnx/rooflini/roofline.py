...
# Axis limits
xmin, xmax, ymin, ymax = 0.01, 100, 1, 13
...
ax.set_xlabel("Arithmetic Intensity [OPs/Byte]", fontsize=15)
ax.set_ylabel("Performance [TOPS]", fontsize=15)
...
cpu_roofs = [
  {"name" : "INT8xINT8 Peak",    "val" : 10},
  {"name" : "BFLOAT16xBFLOAT16 Peak", "val" : 5}
]
mem_bottlenecks = [
  {"name" : "MT Bandwidth",     "val" : 150},
  {"name" : "IT to CT Bandwidth",     "val" : 128},
  {"name" : "CT to IT Bandwidth",     "val" : 96},
  {"name" : "DDR5 Bandwidth",    "val" : 81.35}
]
...
# Datapoints
datapoints = [
  # {"AI" : "MyBWHungryBenchmark",     "TOPS" : 20.00,  "label"  : "I'm lame",          "prop" : ["whatever", "..."]},
  # {"AI" : 10,                        "TOPS" : 1000.00,  "label"  : "I'm pretty cool",  "prop" : ["whatever", "..."]},
  # {"AI" : "MyCPUIntensiveBenchmark", "TOPS" : 3000.00, "label"  : "I'm unbelievable", "prop" : ["whatever", "..."]},
...
for slope in mem_bottlenecks:
  print("slope\t\"" + slope["name"] + "\"\t\t" + str(slope["val"]) + " GB/s", end=' ')
...
for point in datapoints:
  ...
  ax.scatter(AI, point["TOPS"], label=point["label"], zorder=100)
